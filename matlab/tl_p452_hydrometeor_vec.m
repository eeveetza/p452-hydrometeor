function Lpq = tl_p452_hydrometeor_vec(d, f, lat1, lon1, lat2, lon2, h1loc, h2loc, alpha1loc, alpha2loc, eps1loc, eps2loc, G1, G2, BW1, BW2, p, q, press, wat_vap_dens, Rm, T, M1, M2, M3)
%tl_p452_hyodrometeor transmission loss due to hydrometeor scatterrer according to ITU-R P.452-18
...
for n = 1 : M3
    ...
    for i = 1 : M1
        for j = 1 : M2
            ...
            % old = phis;
            [rA1, rA2, dB1, dB2, epsA1, epsA2, alphaA1, alphaA2, thetaA1, thetaA2, phis, alpha_vi, alpha_vs] = hydrometeor_geometry_vec(rho_i(i), phi_j(j), z_n(n), d, x0, y0, h0, h2, eps1loc, eps2loc, alpha1loc, alpha2loc);
            %old-phis
            ...
            %sigma = bistatic_cross_section(rho_i(i), phi_j(j), z_n(n), eta, phis, d, x0, y0, h0, h2, rA1, rA2, dB1, dB2);
